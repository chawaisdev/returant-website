...
<nav class="navbar navbar-expand-lg bg-white shadow-sm sticky-top">
    <div class="container">
        <a class="navbar-brand fw-bold fs-3" href="#">
            <span style="color:#ff5722;">Gourmet</span><span style="color:#ffc107;">Grub</span>
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
            <ul class="navbar-nav fw-medium text-uppercase">
                ...
                <li class="nav-item"><a class="nav-link" href="#shawarma">Shawarma</a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="#bbq">BBQ</a></li>
